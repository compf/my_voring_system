...
openssl req -new -nodes -newkey rsa:4096 -keyout src/ballot_collector/pki/ballot_provider.key.pem -out src/ballot_collector/pki/ballot_collector.key.csr.pem
