...
openssl req -new -nodes -newkey rsa:4096 -keyout src/key_provider/pki/key_provider.key.pem -out src/key_provider/pki/key_provider.key.csr.pem -subj "/CN=keyprovider.compf.me"
